...
`theme` is normally supported in mermaid frontmatter, but the plug adds support for the custom themes in the config. `themeDarkmode` and `fillBackground` override the corresponding config settings.
